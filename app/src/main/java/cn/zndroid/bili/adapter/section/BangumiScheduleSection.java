  ...
  private void setWeekDay(HeaderViewHolder headerViewHolder) {
    ...
    switch (weekDay) {
      case ConstantUtil.SUNDAY_TYPE:
        setWeekDayIconAndTitle(headerViewHolder, R.mipmap.bangumi_timeline_weekday_7, "周日");
        break;
      case ConstantUtil.MONDAY_TYPE:
        setWeekDayIconAndTitle(headerViewHolder, R.mipmap.bangumi_timeline_weekday_1, "周一");
        break;
      case ConstantUtil.TUESDAY_TYPE:
        setWeekDayIconAndTitle(headerViewHolder, R.mipmap.bangumi_timeline_weekday_2, "周二");
        break;
      case ConstantUtil.WEDNESDAY_TYPE:
        setWeekDayIconAndTitle(headerViewHolder, R.mipmap.bangumi_timeline_weekday_3, "周三");
        break;
      case ConstantUtil.THURSDAY_TYPE:
        setWeekDayIconAndTitle(headerViewHolder, R.mipmap.bangumi_timeline_weekday_4, "周四");
        break;
      case ConstantUtil.FRIDAY_TYEP:
        setWeekDayIconAndTitle(headerViewHolder, R.mipmap.bangumi_timeline_weekday_5, "周五");
        break;
      case ConstantUtil.SATURDAY_TYPE:
        setWeekDayIconAndTitle(headerViewHolder, R.mipmap.bangumi_timeline_weekday_6, "周六");
        break;
    }
  }
