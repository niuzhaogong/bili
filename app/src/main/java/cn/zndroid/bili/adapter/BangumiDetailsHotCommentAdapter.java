    ...
    public void onBindViewHolder(ClickableViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            switch (hotsBean.getMember().getSex()) {
                case "女":
                    mHolder.mUserSex.setImageResource(R.mipmap.ic_user_female);
                    break;
                case "男":
                    mHolder.mUserSex.setImageResource(R.mipmap.ic_user_male);
                    break;
                default:
                    mHolder.mUserSex.setImageResource(R.mipmap.ic_user_gay_border);
                    break;
            }
