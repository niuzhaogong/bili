...
import cn.zndroid.bili.ui.activitys.SeasonNewBangumiActivity;
    ...
    private void setSeasonIcon(HomeBangumiSeasonNewSection.HeaderViewHolder headViewHolder) {
        switch (season) {
            case 1:
                ...
                headViewHolder.mSeasonIcon.setImageResource(R.mipmap.bangumi_home_ic_season_1);
                break;
            case 2:
                //春季
                headViewHolder.mSeasonText.setText("4月新番");
                headViewHolder.mSeasonIcon.setImageResource(R.mipmap.bangumi_home_ic_season_2);
                break;
            case 3:
                //夏季
                headViewHolder.mSeasonText.setText("7月新番");
                headViewHolder.mSeasonIcon.setImageResource(R.mipmap.bangumi_home_ic_season_3);
                break;
            case 4:
                //秋季
                headViewHolder.mSeasonText.setText("10月新番");
                headViewHolder.mSeasonIcon.setImageResource(R.mipmap.bangumi_home_ic_season_4);
                break;
        }
    }
