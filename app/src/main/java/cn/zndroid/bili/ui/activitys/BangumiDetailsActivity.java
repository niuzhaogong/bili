...
import cn.zndroid.bili.adapter.BangumiDetailsCommentAdapter;
import cn.zndroid.bili.adapter.BangumiDetailsHotCommentAdapter;
import cn.zndroid.bili.adapter.BangumiDetailsRecommendAdapter;
import cn.zndroid.bili.adapter.BangumiDetailsSeasonsAdapter;
import cn.zndroid.bili.adapter.BangumiDetailsSelectionAdapter;
import cn.zndroid.bili.adapter.helper.HeaderViewRecyclerAdapter;
import cn.zndroid.bili.entity.Bangumi.BangumiDetailsCommentInfo;
...
public class BangumiDetailsActivity extends RxBaseActivity {
    ...
    public void initToolbar() {
        ...
        //设置StatusBar透明
        StatusBarUtil.from(BangumiDetailsActivity.this).setTransparentStatusbar(true).process();
