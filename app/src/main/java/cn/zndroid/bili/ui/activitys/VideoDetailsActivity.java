...
import cn.zndroid.bili.adapter.event.AppBarStateChangeEvent;
import cn.zndroid.bili.entity.video.VideoDetailsInfo;
import cn.zndroid.bili.net.RetrofitHelper;
import cn.zndroid.bili.net.UrlHelper;
import cn.zndroid.bili.ui.fragment.VideoCommentFragment;
import cn.zndroid.bili.ui.fragment.VideoIntroductionFragment;
import cn.zndroid.bili.utils.ConstantUtil;
import cn.zndroid.bili.utils.DisplayUtil;
...
public class VideoDetailsActivity extends RxBaseActivity {
    ...
    public void initToolbar() {
        ...
        //设置StatusBar透明
        StatusBarUtil.from(VideoDetailsActivity.this).setTransparentStatusbar(true).process();
