...
import cn.zndroid.bili.widget.LoveLikeLayout;
...
public class LivePlayerActivity extends RxBaseActivity {
    ...
    private void getLiveUrl() {
        RetrofitHelper.getLiveAPI()
                ...
                .subscribe(aLong -> {
                    ...
                    mRightPlayBtn.setImageResource(R.mipmap.ic_tv_stop);
                    mBottomPlayBtn.setImageResource(R.mipmap.ic_portrait_stop);
                }, throwable -> LogUtil.e("直播地址url获取失败" + throwable.getMessage()));
    }
    ...
    private void ControlVideo() {
        if (isPlay) {
            ...
            isPlay = false;
            mRightPlayBtn.setImageResource(R.mipmap.ic_tv_play);
            mBottomPlayBtn.setImageResource(R.mipmap.ic_portrait_play);
        } else {
            ijkMediaPlayer.start();
            isPlay = true;
            mRightPlayBtn.setImageResource(R.mipmap.ic_tv_stop);
