...
import cn.zndroid.bili.net.api.AccountService;
import cn.zndroid.bili.net.api.BangumiService;
import cn.zndroid.bili.net.api.BiliApiService;
import cn.zndroid.bili.net.api.BiliAppService;
import cn.zndroid.bili.net.api.BiliGoService;
import cn.zndroid.bili.net.api.Im9Service;
import cn.zndroid.bili.net.api.LiveService;
import cn.zndroid.bili.net.api.RankService;
import cn.zndroid.bili.net.api.SearchService;
import cn.zndroid.bili.net.api.UserService;
import cn.zndroid.bili.net.api.VipService;
...
public class RetrofitHelper{
    ...
    private static class CacheInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (CommonUtil.isNetworkAvailable(MyApp.getmInstance())) {
                //有网络时只从网络获取
